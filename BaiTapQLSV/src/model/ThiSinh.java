...
public class ThiSinh {
    ...
    public boolean equals(Object o) {
        ...
        return getMaThiSinh() == thiSinh.getMaThiSinh() && isGioiTinh() == thiSinh.isGioiTinh() && Float.compare(thiSinh.getDiemMon1(), getDiemMon1()) == 0 && Float.compare(thiSinh.getDiemMon2(), getDiemMon2()) == 0 && Float.compare(thiSinh.getDiemMon3(), getDiemMon3()) == 0 && getTenThiSinh().equals(thiSinh.getTenThiSinh()) && getQueQuan().equals(thiSinh.getQueQuan()) && getNgaySinh().equals(thiSinh.getNgaySinh());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getMaThiSinh(), getTenThiSinh(), getQueQuan(), getNgaySinh(), isGioiTinh(), getDiemMon1(), getDiemMon2(), getDiemMon3());
    }
